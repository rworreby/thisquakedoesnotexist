...
coverage: ## check code coverage quickly with the default Python
	coverage run --source thisquakedoesnotexist -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/thisquakedoesnotexist.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ thisquakedoesnotexist
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
