...
# -------- Input Parameters -------
config_d = {
    'data_file': '/scratch/train_Dist/downsamp_5x_sel.npy',
    'attr_file': '/scratch/train_Dist/wforms_table_sel.csv',
    ...
    'out_dir': '/scratch/exp_gan1d_5x/b10_c5_lr4',
    'print_every': 400,
    'save_every': 1,
}
...
x_r = x_r.squeeze()
plot_waves_1C(x_r, DT, t_max=T_MAX, show_fig=SHOW_FIG, fig_file=fig_file,stitle=stl, color='C0')
...
# plot_waves_1C(z, DT, t_max=4.0, show_fig=SHOW_FIG, fig_file=fig_file,stitle=stl, color='C4')
...
x_g = x_g.squeeze()
x_g = x_g.detach().cpu()
plot_waves_1C(x_g, DT, t_max=T_MAX, show_fig=SHOW_FIG, fig_file=fig_file,stitle=stl, color='C1')
...
fig_file = os.path.join(OUT_DIR, f"gan_losses.pdf")
