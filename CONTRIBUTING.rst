...
Report bugs at https://github.com/rworreby/thisquakedoesnotexist/issues.
...
The best way to send feedback is to file an issue at https://github.com/rworreby/thisquakedoesnotexist/issues.
...
1. Fork the `thisquakedoesnotexist` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/thisquakedoesnotexist.git
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/rworreby/thisquakedoesnotexist/pull_requests
