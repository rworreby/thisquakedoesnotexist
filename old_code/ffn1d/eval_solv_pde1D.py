...
# %%
# load train data
x_data_file = os.path.join(DATA_DIR, f"x_data.npy")
y_data_file = os.path.join(DATA_DIR, f"y_data.npy")
...
# reshape x dimension
x_train = x_train.reshape(NTRAIN, Lt, 1)
x_test = x_test.reshape(NTEST, Lt, 1)
...
import gan_fno1d
reload(gan_fno1d)
from gan_fno1d import Generator
