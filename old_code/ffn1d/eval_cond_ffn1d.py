...
# -------- Input Parameters -------
config_d = {
    'data_file': '/scratch/mflorez/gmpw/train_ffn1D/train_Dist/downsamp_5x_sel.npy',
    'attr_file': '/scratch/mflorez/gmpw/train_ffn1D/train_Dist/wforms_table_sel.csv',
    ...
    'gan_file': 'gan_cond_fno1d.py',
    # Conditional Configuration
    # number of distance bins
    'ndist_bins': 10,
    # ------------------------- output configuration ---------------------
    #'out_dir': '/scratch/mflorez/fourier/ffn1D/exp/m64_lr5_2',
    'out_dir': '/scratch/mflorez/fourier/ffn1D/cond/m64_lr5',
    'print_every': 400,
    'save_every': 1,
}
...
# prepare data loader
dataset = WaveDatasetDist(data_file=DATA_FILE, attr_file=ATTR_FILE, ndist_bins=NDIST_BINS )
# create train loader
...
#%%
# ----- Testing models ------
import gan_cond_fno1d
reload(gan_cond_fno1d)
from gan_cond_fno1d import Generator, Discriminator
# ----- test Discriminator-----
